...
class Generator {
  ...
  List<List<int>> _toColumnFormat(Image imgSrc, int lineHeight) {
    ...
    // final imgRgba8 = image.convert(format: Format.uint8, numChannels: 4); // Make sure it's an RGBA 32-bit image like v3
    // grayscale(imgRgba8); // map the pixels to grayscale (luminance)
